...
<input type="hidden" name="_method" value="PUT">
{{ csrf_field() }}
<i class="far fa-star"  onclick="event.preventDefault();document.getElementById('etoileform1').submit();"><input class="switch-input" type="namber" name="etoile1" value="1"></i>
</form>
